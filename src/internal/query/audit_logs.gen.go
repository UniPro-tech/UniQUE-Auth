...
func newAuditLog(db *gorm.DB, opts ...gen.DOOption) auditLog {
	...
	_auditLog.ApplicationID = field.NewString(tableName, "application_id")
	_auditLog.SessionID = field.NewString(tableName, "session_id")
	_auditLog.Action = field.NewString(tableName, "action")
	_auditLog.TargetResource = field.NewString(tableName, "target_resource")
	_auditLog.Trusted = field.NewBool(tableName, "trusted")
	_auditLog.Details = field.NewString(tableName, "details")
...
type auditLog struct {
	...
	SessionID      field.String // If author is application, this links to the jti
	Action         field.String
...
func (a *auditLog) updateTableName(table string) *auditLog {
	...
	a.Trusted = field.NewBool(table, "trusted")
	a.Details = field.NewString(table, "details")
