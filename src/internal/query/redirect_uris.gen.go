...
func newRedirectURI(db *gorm.DB, opts ...gen.DOOption) redirectURI {
	...
	_redirectURI.ApplicationID = field.NewString(tableName, "application_id")
	...
	_redirectURI.DeletedAt = field.NewField(tableName, "deleted_at")
...
func (r *redirectURI) updateTableName(table string) *redirectURI {
	...
	r.ApplicationID = field.NewString(table, "application_id")
...
func (r *redirectURI) fillFieldMap() {
	...
	r.fieldMap["application_id"] = r.ApplicationID
