...
class AuthenticationRequest(BaseModel):
    response_type: str = Field(..., description="REQUIRED. Must be 'code' for Authorization Code Flow")
    ...
    redirect_uri: str = Field(..., description="REQUIRED. Redirection URI to return the response")
    state: Optional[str] = Field(None, description="RECOMMENDED. Opaque value for maintaining state")
    nonce: Optional[str] = Field(None, description="OPTIONAL. String value to associate client session with ID Token")
    display: Optional[str] = Field(None, description="OPTIONAL. ASCII string value to specify UI display")
    prompt: Optional[str] = Field(None, description="OPTIONAL. Space delimited, case sensitive list of ASCII values")
    max_age: Optional[int] = Field(None, description="OPTIONAL. Maximum Authentication Age in seconds")
    ui_locales: Optional[str] = Field(None, description="OPTIONAL. End-User's preferred languages and scripts for UI")
    id_token_hint: Optional[str] = Field(None, description="OPTIONAL. Previously issued ID Token")
